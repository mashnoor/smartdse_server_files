...
import threading, time, urllib, json, datetime, sys, subprocess, os
...
''''''
news_link = "generatenews.php"
home_link = "homeupdate.py"
topitems_link = "topitems.php"
topshares_link = "top20shares.php"
generateitem_link = "generateitemlist.php"
dse30_link = "dse30shares.php"
...
class dse_up(threading.Thread):
    ...
    def run(self):
		while True:
			if self.web_link == home_link:
				f = "python " + os.path.abspath(self.web_link)
			else:
